...
function cd_makeTableHTML(myArray) {
  var result = "<div style='width:100vw;height:100vh;background:#80808080;backdrop-filter:blur(2px);top:0;left:0px;position:absolute;'><table  class='cd_render_table'>";
